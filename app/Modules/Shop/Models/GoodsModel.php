...
class GoodsModel extends Model
{
    ...
    protected $fillable = [
        ...
        'sales_num', 'comments_num','view_num','is_delete','recommend_text','seo_title','seo_keyword','seo_desc','good_comment','file',
        'nature','tags',
    ];
...
//    设计师空间
    static public function goodserviceEvaluateDetail($uid,$paginate){
        $good = GoodsModel::select('goods.*','cate.name as catename')
            ->where('uid',$uid)

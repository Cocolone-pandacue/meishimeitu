...
class AuthController extends UserCenterController
{
    ...
    public function postRealnameAuth(RealnameAuthRequest $request)
    {
        ...
        $realnameInfo['card_front_side'] = $request->get('card_front_side');
        $realnameInfo['card_back_dside'] = $request->get('card_back_dside');
        $realnameInfo['validation_img'] = $request->get('validation_img');

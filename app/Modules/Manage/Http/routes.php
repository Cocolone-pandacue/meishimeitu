...
//设计师
    Route::get('/stylistAuthList', 'AuthController@stylistAuthList')->name('stylistAuthList');
    Route::get('/stylistAuth/{id}', 'AuthController@stylistAuth')->name('stylistAuth');
    Route::get('/stylistDownload/{id}', 'AuthController@stylistDownload')->name('stylistDownload');
    Route::get('/stylistAuthHandle/{id}/{action}', 'AuthController@stylistAuthHandle')->name('stylistAuthHandle');
...
//    项目审核成功
    ...
    Route::get('/config/appMessage', 'ConfigController@getConfigAppMessage')->name('getConfigAppMessage');
    Route::post('/config/appMessage', 'ConfigController@saveConfigAppMessage')->name('configAppMessageUpdate');
    ...
    //    平台商铺
    Route::get('/goodsSlideshow', 'ShopController@goodsSlideshow')->name('goodsSlideshow');
    Route::get('/goodsSlideshowAdd', 'ShopController@goodsSlideshowAdd')->name('goodsSlideshowAdd');
    Route::post('/goodsSlideshowAdd', 'ShopController@goodsSlideshowAdd')->name('goodsSlideshowAdd');
    Route::get('/goodsSlideshowInfo/{id}', 'ShopController@goodsSlideshowInfo')->name('goodsSlideshowInfo');
    Route::post('/goodsSlideshowInfosave', 'ShopController@goodsSlideshowInfosave')->name('goodsSlideshowInfosave');
	...
	Route::post('/checkServiceDeny','GoodsServiceController@checkServiceDeny')->name('checkServiceDeny');

        <nav class="navbar navbar-expand-md bg-dark navbar-dark">
            <div class="navbar-header">
                ...
                <button class="navbar-toggle" type="button" data-toggle="collapse" data-target="#ssss">
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button>
            </div>
            <div class="collapse navbar-collapse" id="ssss">
                <ul class="navbar-nav menu_list">
                    ...
                    <li id="find_designer" class="myproductionUploading">
                        <a href="/user/productionUploading" class="ho_color">设计师入驻</a>
                    </li>
                                @endif
                            @elseif(Theme::get('realname') ==2)
                                {{--实名认证等待或者失败的--}}
                    <li id="find_designer" class="myproductionUploading">
                        <a href="/user/realnameAuth" class="ho_color">设计师入驻</a>
                    </li>
                    ...
                    <li id="find_designer" class="myproductionUploading">
                        ...
                        @else
                    <li id="find_designer" class="myproductionUploading">
                        <a href="javascript:;" class="ho_color no_register">设计师入驻</a>
                    </li>
                        @endif
                    <li class="mytask">
                    ...
                    <form class="navbar-form navbar-right" action="/task" role="search" method="get" class="switchSearch" >
                        @if(!Auth::check())

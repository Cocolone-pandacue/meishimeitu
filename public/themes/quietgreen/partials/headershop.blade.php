                        ...
                        <ul class="pull-left g-taskbarlist hidden-sm hidden-xs">
                            <li class="pull-left g-taskbarli"><a class="g-taskbar1 g-taskbarbor" href="/user/myTasksList">我是雇主 <i
                                ...
                                <div class="g-taskbardown1">
                                    <div><a class="cor-blue2f" href="/task/type">发布任务</a></div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 hidden-xs">
                    <div class="row">
                        <a href="{!! CommonClass::homePage() !!}">
                            ...
                            @else
                                <img src="{!! Theme::asset()->url('images/mb1/logo-slogn.png') !!}" class="img-responsive wrap-side-img">
                            @endif
                        </a>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-left">
                <nav class="navbar bg-blue navbar-default hov-nav" role="navigation">
                    <div class="navbar-header pull-left g-logo hidden-xs">
                        <a href="{!! CommonClass::homePage() !!}" class="g-logo hidden-xs hidden-sm">
                            @if(Theme::get('site_config')['site_logo_2'] && is_file(Theme::get('site_config')['site_logo_2']))
                                <img class="a_img" src="{!! url(Theme::get('site_config')['site_logo_2'])!!}" alt="kppw" width="">
                            @else
                                <img class="a_img" src="{!! Theme::asset()->url('images/logo.png') !!}" alt="kppw" width="">
                            @endif
                        </a>
                    ...
                    <div class="collapse navbar-collapse pull-right g-nav pd-left0 pos-rela hover_div" id="example-navbar-collapse">
                        <div class="div-hover hidden-xs"></div>
                        <ul class="nav navbar-nav overhide  hover_ul">
                            ...
                            @endif
                            <li class="s-sign clearfix hidden-md hidden-xs hidden-sm navactiveImg hover_li">
                                @if(Auth::check())
                                    {{--<div class="z-navactive topheadposi1">--}}
                                    <a href="javascript:;" class="u-img topheadimg" data-toggle="dropdown" class="dropdown-toggle"><img src="@if(!empty(Theme::get('avatar')) && is_file(Theme::get('avatar'))) {!!  url(Theme::get('avatar')) !!} @else {!! Theme::asset()->url('images/default_avatar.png') !!} @endif" alt="..."  class="img-circle head-uploade-after hover_img" width="31" height="34" ></a>
                            ...
                            <li class="pd-navppd ">
                                <form class="navbar-form navbar-left hd-seachW hover_form" action="/shop/work/{!! Theme::get('SHOPID') !!}" role="search" method="get" class="switchSearch">
                                    <div class="input-group input-group-btnInput">
                                        ...
                                        <a href="/task/type" type="submit" class="btn btn-default f-click cor-blue bor-radius2 hidden-lg hidden-md">发布任务</a>
                                    </div>
                                    <span class="hidden-md hidden-xs hidden-sm">&nbsp;&nbsp;<span class="u-tit">或</span>&nbsp;&nbsp;
                                    <a href="/task/type" type="submit" class="btn btn-default f-click cor-blue bor-radius2">发布任务</a></span>
                    ...
                    <div class="hidden-lg hidden-sm hidden-md">
                        <div class="navbar-header">
                            ...
                            <a href="/task/type" type="submit" class=" f-click bor-radius2 hidden-lg hidden-md cor-white f-click-btn">发布任务</a>
                        </div>
    ...
    <div class="row">
        <div class="info_wrap">
            ...
            <ul class="clearfix title_wrap">
                <li><a class="ho_color" href="/shop/manage/{!! Theme::get('SHOPID') !!}">首页</a></li>
                <li><a class="ho_color" href="/shop/collect/{!! Theme::get('SHOPID') !!}">收藏</a></li>
                <li><a class="ho_color" href="/shop/work/{!! Theme::get('SHOPID') !!}">店铺</a></li>
                <li><a class="ho_color" href="/shop/about/{!! Theme::get('SHOPID') !!}">资料</a></li>
            </ul>
        </div>
    </div>
</div>

...
//编辑器类容提交
    ...
    $('.area-limit').on('click',function(){
     ...
     // 发布项目中 地区选择 默认状态
    var value = $('#area_check').val();
    if($("div").hasClass("xianshi")){
        $(".zddq").removeClass('bar-txt');
        $(".bxdq").addClass('bar-txt');
        $('#area_select').show();
        $('#region-limit').attr('value',value);
    }
...
//             // $(window).attr('location','http://www.meishimeitu.com/task/createnew/'+data.orderNumber+'?a=03');

/*
* @Author: Marte
* @Date:   2019-01-21 14:35:02
* @Last Modified by:   Marte
* @Last Modified time: 2019-02-15 16:20:36
*/
...
'use strict';
    ...
    document.addEventListener('DOMContentLoaded',function(){
      ...
      document.querySelector('.waves1').addEventListener('click',function(e){
        show(e);
      },!1);
    },!1);
     ...
     /* document.querySelector('.waves1').addEventListener('click',function(e){
      ...
      document.querySelector('.wavesb').addEventListener('click',function(e){
        show(e);
      },!1);*/
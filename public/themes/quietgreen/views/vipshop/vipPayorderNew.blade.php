    ...
    <div class="container ">
        <div class="row">
            ...
            <div class="col-xs-12 col-left">
                <div class="taskDetails alert taskbg clearfix vippayorder textalign">
                        ...
                        <div class="tab-content clearfix f-tab">
                            ...
                            @if($userInfo->balance > $order->cash)
                                <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                                    <form class="form-horizontal" role="form" action="{{url('vipshop/vipPayorderNew')}}" method="post" name="bounty-form">
                                        {!! csrf_field() !!}
                        ...
                        @else
                            <!--余额不足状态-->
                                <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                                    ...
                                    {{--<a href="/task/release/{{ $id }}" class="cor-gray93 btn-big1">返回</a>--}}
                                    <br>
                                </div>
                        @endif
                        <!--第三方支付-->
                            <div class="tab-pane clearfix" id="home2">
                                <form class="form-horizontal" role="form" action="{{url('vipshop/thirdPayorderNew')}}" method="post" name="bounty-form" target="_blank">
                                    {!! csrf_field() !!}
                                    <input type="hidden" name="code" value="{{$code}}">
                                    <div class="space"></div>
                                ...
                                <div class="modal-body text-center clearfix">
                                    ...
                                    <div class="col-sm-8 hidden-xs">
                                        <div class="cor-gray51 text-left">
                                            ...
                                            <p>
                                                ...
                                                <a target="_blank"  href="{!! CommonClass::contactClient(Theme::get('basis_config')['qq']) !!}" class="cor-blue167 text-under">支付遇到问题</a>
                                            </p>
                                    ...
                                    <div class="hidden-lg hidden-md hidden-sm visible-xs-12">
                                        <div class="cor-gray51 text-center">
                                            ...
                                            <p>
                                                <a href="/task/1489" type="button" class="btn btn-primary btn-sm btn-blue btn-big1 bor-radius2">已完成付款</a>&nbsp;
                                                <a target="_blank"  href="{!! CommonClass::contactClient(Theme::get('basis_config')['qq']) !!}" class="cor-gray97 modaltxt">支付遇到问题</a>
                                            </p>

        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-left">
                <div class="taskDetails taskbg clearfix taskSuccess">
                    ...
                    <div class="taskSuccess-right col-lg-7 col-md-9 col-sm-10 col-xs-12 textalign">
                        <h4 class="text-size24 color">恭喜,您已完成付款&nbsp;</h4>
                        <p class="cor-gray51 text-size14">页面将在<span id="show"></span>秒后自动跳转到<a href="/">首页</a></p>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function refer(){
        ...
        if (vipTime>=0){
            document.getElementById('show').innerHTML=""+vipTime+""; // 显示倒计时
            vipTime--; // 计数器递减
        }

<section>
    <div class="container">
        <div class="row">
            ...
            <p class="project_title">项目详情</p>
            <div class="col-xs-12">
                <div class="row">
                    <div class="col-lg-9 list-l col-md-12 col-left">
                        {{--修改--}}
                        <div class="clearfix">
                            <div class="clearfix pd-padding30 b-border active in pre_head">
                                <div class="clearfix">
                                    <div class="col-lg-9 cor-left">
                                        <div class="row cor-gray51 text-size18">
                                    ...
                                    <div class="col-lg-3 pd-border">
                                        @if($task_type_alias == 'xuanshang')
                                            ...
                                            <p>
                                            <span class="red_word text-size36">
                                                {{ $detail['bounty'] }}
                                            </span>元
                                            </p>
                                        @elseif($task_type_alias == 'zhaobiao')
                            ...
                            <div class="bg-white clearfix b-border">
                                <div class="tasksidebg-white">
                                    <div class="task-sidetime time">
                                        ...
                                        @elseif($detail['status']==3 && strtotime($detail['begin_at'])>time())
                                            此任务当前处于：<span class="bl_color">投稿</span>状态
                                        @elseif($detail['status']==4)
                                            此任务当前处于：<span class="bl_color">投稿</span>状态
                                        @elseif($detail['status']==5)
                                            此任务当前处于：<span class="bl_color">选稿</span>状态
                                        @elseif($detail['status']==6)
                                            此任务当前处于：<span class="bl_color">公示</span>状态
                                        @elseif($detail['status']==7)
                                            此任务当前处于：<span class="bl_color">验收</span>状态
                                        @elseif($detail['status']==8)
                                            此任务当前处于：<span class="bl_color">互评</span>状态
                                        @elseif($detail['status']==9)
                                            此任务当前处于：<span class="bl_color">已结束</span>状态
                                        @elseif($detail['status']==10)
                                            此任务当前处于：<span class="bl_color">失败</span>状态
                                        @elseif($detail['status']==11)
                                            此任务当前处于：<span class="bl_color">维权</span>状态
                                        @endif
                                        @if($detail['status']==3 && strtotime($detail['begin_at'])>time())
                                            离投稿开始还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['begin_at'])) }}" class="bl_color text-size20 timer-check"></b>
                                        @endif
                                        @if($detail['status']==3 && strtotime($detail['begin_at'])>time())
                                            离投稿结束还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['delivery_deadline'])) }}" class="bl_color text-size20 timer-check"></b>
                                        @endif
                                        @if($detail['status']==4)
                                            离投稿结束还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['delivery_deadline'])) }}" class="bl_color text-size20 timer-check"></b>
                                        ...
                                        @if($detail['status']==5)
                                            ...
                                            离选稿结束还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['selected_work_at'])+$task_select_work) }}" class="bl_color text-size20 timer-check"></b>
                                        @endif
                                        @if($detail['status']==6)
                                            <div style="display:none">
                                                @if($task_type_alias == 'xuanshang')
                                            ...
                                            离公示结束还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['publicity_at'])+$task_publicity_day) }}" class="bl_color text-size20 timer-check"></b>
                                        @endif
                                        @if($detail['status']==7)
                                            <div style="display:none">
                                                @if($task_type_alias == 'xuanshang')
                                                ...
                                                @if(($task_type_alias == 'zhaobiao' && $pay_case_status == 1) || $task_type_alias == 'xuanshang')
                                                    离验收结束还剩：
                                                    <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['checked_at'])+$task_delivery_max_time) }}" class="bl_color text-size20 timer-check"></b>
                                                @endif
                                        @endif
                                        @if($detail['status']==8)
                                            <div style="display:none">
                                            ...
                                            离互评结束还剩：
                                            <b  delivery_deadline="{{ date('Y/m/d H:i:s',strtotime($detail['comment_at'])+$task_comment_time_limit) }}" class="bl_color text-size20 timer-check"></b>
                                        @endif
                                        @if($detail['status']==11)
                                            请等待后台的处理结果
                                        @endif
                                    ...
                                    @elseif($detail['status']==7 && $user_type==2 && $is_win_bid)
                                        ...
                                        @else
                                            @if(!$is_delivery)
                                                    <a href="/task/delivery/{{ $detail['id'] }}" class="btn btn-primary bor-radius2">
                                                        去交付
                                                    </a>
                                            @endif
                                        @endif
                                ...
                                <div id="home" class="tab-pane fade  bg-white active in">
                                    ...
                                    <div class="task-description cor-gray51">
                                        <div class="description-main">
                                            <p class="h4 description-title">项目类型</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:55px;overflow:hidden;">
                                                {{ $detail['cate_name'] }}
                                            </div>
                                        </div>
                                        <div class="description-main">
                                            <p class="h4 description-title">项目详情</p>
                                        ...
                                        <div class="description-main">
                                            <p class="h4 description-title">截止日期</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:55px;overflow:hidden;">
                                                {{ date('Y年m月d日', strtotime($detail['delivery_deadline'])) }}
                                            </div>
                                        </div>
                                        @if($detail['region_limit'])
                                        <div class="description-main">
                                            <p class="h4 description-title">指定地址</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:55px;overflow:hidden;">
                                                @if($detail['region_limit'])
                                                        @if(isset($area[$detail['province']]['name']))
                                                            {{ $area[$detail['province']]['name']}}
                                        ...
                                        @if(!empty($industry))
                                        <div class="description-main">
                                            <p class="h4 description-title">所属行业</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:55px;overflow:hidden;">
                                                {{$industry}}
                                            </div>
                                        </div>
                                        ...
                                        @if(!empty($reference))
                                        <div class="description-main">
                                            <p class="h4 description-title">参考产品</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:55px;overflow:hidden;">
                                                    {{$reference}}
                                            </div>
                                        </div>
                                        ...
                                        @if(!empty($task_style))
                                        <div class="description-main">
                                            <p class="h4 description-title">设计风格</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:auto;overflow:hidden;">
                                                <div class="select_style fl">
                                                    @foreach($task_style as $v)
                                                        <p>{{$style_conf[$v]}}</p>
                                                    @endforeach
                                                </div>
                                            </div>
                                        ...
                                        @endif
                                        @if(!empty($task_tonality))
                                        <div class="description-main">
                                            <p class="h4 description-title">颜色</p>
                                            <div class="h5 height-line24 " style="word-break:break-all;height:auto;overflow:hidden;">
                                                <ul class="select_color clearfix fl">
                                                @foreach($task_tonality as $v)
                                                    <li>
                                                        <img class="color_class" src="/themes/quietgreen/assets/images/type/{{$tonality_conf[$v]}}.png" alt="">
                                                        <p>{{$tonality_conf[$v]}}</p>
                                                    </li>
                                                @endforeach
                                                </ul>
                                        ...
                                        <div class="description-main task-taskdisplay">
                                            <div>
                                                <p class="h4 description-title"><b>项目附件<span class="text-muted">({{ count($attatchment) }})</span></b></p>
                                                <!-- <span class="hr"></span> -->
                                            </div>
                                        ...
                                        {{--经纪人后期加--}}
                                            <div class="description-main">
                                                <p class="h4 description-title">经纪人</p>
                                                <div class="h5 height-line24 js_moreDetail" style="word-break:break-all;height:55px;overflow:hidden;">
                                                    {{--经纪人“用户名”代客户发布的项目--}}
                                                </div>
                                            </div>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body text-center">
                                                                                ...
                                                                                <div class="space"></div>
                                                                                <p>
                                                                                    <button class="btn btn-primary btn-sm btn-big1 btn-blue bor-radius2 win-bid  z_sure"
                                                                                            type="button"
                                                                                            task_id="{{ $detail['id'] }}"
                                                                                            work_id="{{ $v['id'] }}"
                                                                                            @if($task_type_alias == 'xuanshang')
                                                                                    ...
                                                                                    <button class="btn btn-default btn-sm btn-big1 btn-gray999 bor-radius2 z_cancel"
                                            ...
                                            <div class="bidrecords">
                                                <div class="evaluate">
                                                    <div class="record pd-pdtp0">
                                                        <div class="row">
                                                            <div class="col-md-1 col-xs-2 task-bidMedia evaluateimg"><img src="{{ ossUrl($v['avatar']) }}" onerror="onerrorImage('{{ Theme::asset()->url('images/defauthead.png')}}',$(this))"></div>
                                                            <div class="col-md-11 col-xs-10 evaluatemain">
                            ...
                            <div class="task-sidetime clearfix">
                                ...
                                <div class="visible-lg-inline-block visible-md-inline-block visible-sm-inline-block visible-xs-inline-block col-xs-6">
                                    <div class="row">
                                        ...
                                        <p class="text-size20 text-center mg-margin gr_color text-blod">{{ $works_winbid_count }}</p>
                                    </div>
                                </div>
                            </div>
...
{!! Theme::asset()->container('old-css')->usepath()->add('release_css','css/type/designer_type.css') !!}

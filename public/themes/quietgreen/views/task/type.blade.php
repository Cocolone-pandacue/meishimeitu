...
<div class="project_content ">
    ...
    <ul class="project_type clearfix">
        ...
        <li id="logo_info">
            @if(empty($broker['bid']))
                <a class="logo_info_a"  href="/task/createnewdetail/{{$c->id}}/{{$orderNumber}}?a=02">
            @else
                <a class="logo_info_a"  href="/task/createnewdetail/{{$c->id}}/{{$orderNumber}}?bid={{$broker['bid']}}&man={{$broker['man']}}&a=02">
            @endif
...
{{--<div class="other_type clearfix hide">--}}
    {{--<div class="other_type_wrap clearfix">--}}
        {{--<ul class="other_type_title_box clearfix">--}}
            ...
            {{--<li class="other_type_title"><a href="javascript:;">{!! Theme::get('task_cate')[$j]['name'] !!}</a> --}}
            {{--<!-- /task/createnew/{{$a = Theme::get('task_cate')[$j]['id']}} -->--}}
                {{--@for($j = 0; $j < count(Theme::get('task_cate')); $j++)--}}

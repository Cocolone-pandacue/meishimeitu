<div class="mymoney_fenlei">
    ...
    <p class="mymoney_xifen_leixing">
        ...
        <a href="{!! url('finance/cashout') !!}" class="mymoney_xifen_leixing_click">我要提现</a>
    </p>
</div>
        ...
        <div id="user-profile-2" class="profile-users">
            <div class="memberdiv">
                <div class="cor-gray51 position-relative memberdiv-validform">
                    ...
                    <input type="text"  name="cash" class="border_3 width_height inputxt" datatype="number" nullmsg="输入金额" errormsg="请输入正确的金额" value="{!! old('cash') !!}" />

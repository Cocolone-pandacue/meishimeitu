<div class="mymoney_fenlei">
    ...
    <p class="mymoney_xifen_leixing">
        ...
        <a href="{!! url('finance/cash') !!}" class="mymoney_xifen_leixing_click">我要充值</a>
            ...
            <div class="memberdiv">
                <div class="cor-gray51 position-relative" id="cashtips">充值金额：
                    <span class="inlineblock">
                        <input type="text" class="bor-radius2" name="cash" datatype="cashValid" data-recharge-min="{!! $recharge_min !!}"  nullmsg="请输入充值金额" errormsg="充值金额不小于{!! $recharge_min !!}元"/> 元&nbsp;&nbsp;&nbsp;
                    </span>

...
<section class="clearfix login_wrap">
    ...
    <div class="sign-main-bg ">
        <div class="sign-main">
            ...
            <div class="sign-main-head">注册成功</div>
            <p class="text-size16 text_style">页面将在 <span id="show" style="color:#CD3333">5</span> 秒后自动跳转到<a href="{!! CommonClass::homePage() !!}" class="cor-green">首页</a></p>
            <a href="{!! CommonClass::homePage()!!}" class="text-size16 cor-green">立即跳转>></a>
        </div>
    </div>
</section>
...
{!! Theme::asset()->container('specific-css')->usepath()->add('activesuccess','css/meishimeitu/activesuccess.css') !!}
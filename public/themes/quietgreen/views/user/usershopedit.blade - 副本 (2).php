...
<form method="post" action="{!! url('user/pubGoods') !!}" enctype="multipart/form-data" >
    ...
    <div class="upload_div ">
        ...
        <div class="upload_div_box">
            ...
            <p class="right">
                <input type="text" id="" class="" name="title" value="{{$shopGoods->title}}">
                <span class="" id=""></span>
            </p>
        </div>
        <div class="upload_div_box">
            ...
            <p class="right">
                <select type="text" id="" class="" name="first_cate" value="">
        ...
        <div class="scbox">
            <p class="left">上传作品<span class="red_word">*</span></p>
            <div class="tpbox">
                <div class="inputbox">
            ...
            @if(!empty($shopGoods->file))
            @foreach(json_decode($shopGoods->file) as $s)
                <img src="{{ossUrl($s)}}" style="width: 300px">
            @endforeach
            @endif
        </div>
        <div class="scbox">
            <p class="left">上传封面<span class="red_word">*</span></p>
            <div class="tpbox">

<div class="g-main g-releasetask">
            ...
            <li>
                <div class="row">
                    <div class="col-lg-9 col-sm-7 col-xs-6 width100">
                        <div class="text-size14 cor-gray51"><a class="cor-blue2f" href="/task/release/{{ $v['id'] }}">{{ $v['title'] }}</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;{{ ($v['status']==0)?'未发布':'未托管' }}&nbsp;&nbsp;&nbsp;@if($v['alias'] =='xuanshang' && $type==0)<span style="position:relative;top:1px;color:#fff;font-size:4px;padding:0 5px;background-color:#1e8cbd;margin-right:1px;">悬赏</span>@elseif($v['alias'] =='zhaobiao' && $type==0)<span style="position:relative;top:1px;color:#fff;font-size:4px;padding:0 5px;background-color:#1e8cbd;margin-right:1px;">招标</span>@endif</div>
        ...
        <div class="text-center">
            ...
            <a class="btn-big bg-blue1 text-size18 bor-radius2" href="/task/type">发布任务</a>
        </div>
        @endif
    </div>

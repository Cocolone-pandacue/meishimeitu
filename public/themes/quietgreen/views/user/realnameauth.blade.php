            ...
            <div class="row profile-users" id="user-profile-2">
                <div class="col-md-12 realimg">
                    ...
                    <div class="clearfix g-userimgupbor" data-placement="right" href="#">
                        <p class="pull-left h5 cor-gray51"><span>身份证正面&nbsp;&nbsp;&nbsp;&nbsp;</span></p>
                        <div class="memberdiv pull-left">
                            <div class="position-relative">
                                <input type="file" id="id-input-file-3"/>
                                <input class="img-url" name="card_front_side" type="hidden"/>
                            </div>
                        </div>
                    ...
                    <div class="clearfix g-userimgupbor" data-placement="right" href="#"><p
                        ...
                        <div class="memberdiv pull-left">
                            <div class="position-relative">
                                ...
                                <input class="img-url" name="card_back_dside" type="hidden" />
                            </div>
                        </div>
                        <div class="pull-left cor-gray87 hidden-xs">
                            <p>1.必须看清证件信息，且证件信息不能被遮挡；</p>
                    ...
                    <div class="clearfix g-userimgupbor" data-placement="right" href="#">
                        <p class="pull-left h5 cor-gray51"><span>手持身份证</span></p>
                        <div class="memberdiv pull-left">
                            <div class="position-relative">
                                <input type="file" id="id-input-file-5"/>
                                <input class="img-url" name="validation_img" type="hidden" />
                            </div>
                        </div>
                        <div class="pull-left cor-gray87 hidden-xs">
...
{!! Theme::asset()->container('custom-js')->usePath()->add('realname-js', 'js/realnameauthV2.js') !!}

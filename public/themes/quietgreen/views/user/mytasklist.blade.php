...
<ul class="myproject">
    ...
    <li class="myproject_photo">
        <div class="myproject_photo_biaoti">共<span>{{$count}}</span>个作品</div>
        <!-- 我的项目  我发布的 -->
        <!-- 还未发布 -->
        @if(count($my_tasks)>0)
        ...
        <div class="myproject_photo_box" id="{{ $v['id'] }}">
            <div class="myproject_photo_box_text">
                ...
                <div class="txlb">
                    ...
                    <div class="txlb_tx" id="ygy_{{ $task['uid'] }}">
                        @if($task['avatar'])
                        <a href="{!! URL('/bre/serviceEvaluateDetail/'.$task['uid']) !!}" target="_blank"><img src="{!! ossUrl($task['avatar']) !!}" alt="" class="tx" onerror="onerrorImage('{{ Theme::asset()->url('images/default_avatar.png')}}',$(this))"></a>
                        ...
                        @else
                        <a href="{!! URL('/bre/serviceEvaluateDetail/'.$task['uid']) !!}" target="_blank"><img src="{!! Theme::asset()->url('images/default_avatar.png') !!}" alt="" class="tx"></a>
                        <div class="tx_tips_another">
                ...
                <div class="txlb">
                    <div class="txlb_tx">
                        <a href="{!! URL('/bre/serviceEvaluateDetail/'.$taskid[$my][0]['uid']) !!}" target="_blank"><img src="{{ossUrl($taskid[$my][0]['avatar'])}}" alt="" class="tx" onerror="onerrorImage('{{ Theme::asset()->url('images/default_avatar.png')}}',$(this))"></a>
                        <div class="tx_tips_another">
                ...
                <div class="txlb">
                    <div class="txlb_tx">
                        <a href="{!! URL('/bre/serviceEvaluateDetail/'.$taskid[$my][0]['uid']) !!}" target="_blank"><img src="{!!Theme::asset()->url('images/default_avatar.png')!!}" alt="" class="tx"></a>
                        <div class="tx_tips_another">
            ...
            <div class="myproject_photo_box_buzhou qiaoliang">
                ...
                <div class="myproject_photo_box_lianjie">
                    @if(in_array($v['status'], [-2]))
                    <a href="/task/type/{{$v['order_number']}}?a=01" target="_blank">
                        <div class="myproject_photo_box_lianjie_cxfb">重新发布</div>
                    </a>
                    @elseif(in_array($v['status'], [-1]))
                    <a href="/task/createnewdetail/{{$v['cate_id']}}/{{$v['order_number']}}?a=02" target="_blank">
                        <div class="myproject_photo_box_lianjie_cxfb">重新发布</div>
                    </a>
                    @elseif(in_array($v['status'], [1]))
                    <a href="/task/createnew/{{$v['order_number']}}?a=03" target="_blank">
                        <div class="myproject_photo_box_lianjie_cxfb">重新发布</div>
                    </a>
                    @endif
                    @if(in_array($v['status'], [-2,-1,1]))

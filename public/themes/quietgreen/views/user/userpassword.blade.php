<div class="g-main clearfix">
    ...
    {!! csrf_field() !!}
        <div class="mymessage_xbiaoti">修改密码</div>
        <div class="xinxibox">
            <div class="xinxibox_left">当前密码</div>
            <div class="xinxibox_right xinxiboxrelative">
                ...
                <span><span class="Validform_checktip col-sm-12 vilidform-wrp1 xinxiboxabsolute"></span></span>
            </div>
        </div>
        <div class="xinxibox">
            <div class="xinxibox_left">设置新密码</div>
            <div class="xinxibox_right xinxiboxrelative">
                ...
                <span><span class="Validform_checktip col-sm-12 vilidform-wrp1 xinxiboxabsolute"></span></span>
                <div class="xinxiboxabsolute_one">
                    <div class="passwordStrength vilidform-passwordlength">安全等级： <span>低</span><span>中</span><span class="last">高</span></div>
                </div>
            </div>
        </div>
        <div class="xinxibox">
            <div class="xinxibox_left">确认新密码</div>
            <div class="xinxibox_right xinxiboxrelative">
        ...
        <div class="buthz">
            <div class="kh"></div>
            <button class="btngs_one" type="submit">确定</button>
        </div>
    </form>
</div>

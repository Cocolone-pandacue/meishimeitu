            ...
            @foreach($goods_list as $item)
                <li class="row width590">
                    <div class="col-sm-1 col-xs-2 usercter">
                        <img src="{!! ossUrl($item->cover) !!}" onerror="onerrorImage('{{ Theme::asset()->url('images/employ/bg2.jpg')}}',$(this))">
                    </div>
                    <div class="col-sm-11 col-xs-10 usernopd">
                        ...
                        <div class="col-sm-3 col-xs-4 text-right hiden590">
                            <a class="btn-big  bor-radius2 hov-blue1b" target="_blank" href="/shop/buyGoods/{!! $item->object_id !!}">查看</a>

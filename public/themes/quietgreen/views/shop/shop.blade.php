                ...
                <div class="col-sm-1 col-xs-2">
                        <div class="row">
                            <div @if($v['type'] == 0) class="g-valugood" @elseif($v['type'] == 1) class="g-valuin" @elseif($v['type'] == 2) class="g-valupoor" @endif>
                                <img class="img-responsive" src="{!! ossUrl($v['avatar']) !!}"  alt="..." onerror="onerrorImage('{{ Theme::asset()->url('images/employ/bg2.jpg')}}',$(this))">
...
<div class="list_wrap">
    <div class="container">
        <div class="row">
            ...
            <p class="all_title_word">全部留言<span class="word_num">3</span></p>
            ...
            <div class="all_leave_word">
                ...
                <div class="h_more_div hide">
                    <p><span class="uname">用户名称</span></p>
                    <p>全部留言全部留言全部留言全部留言全部留言全部留言全部留言</p>
                    <div class="pointh">
            ...
            <div class="all_leave_word">
                ...
                <div class="reply_div hide">
                    <textarea name="" placeholder="回复：用户名称"></textarea>

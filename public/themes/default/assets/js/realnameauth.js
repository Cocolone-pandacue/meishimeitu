...
$(function(){
    ...
    var demo=$(".registerform").Validform({
        ...
        datatype:{
            ...
            "zh2-4":/^[\u4E00-\u9FA5\uf900-\ufa2d]{2,4}$/,
            "idcard":function(gets,obj,curform,datatype){          // gets为绑定的元素的value值
                //该方法由佚名网友提供;
                ...
                if (gets.length == 15) {
                    ...
                    var a_idCard = gets.split("");// 得到身份证数组    split() 方法用于把一个字符串分割成字符串数组。
                ...
                function isTrueValidateCodeBy18IdCard(a_idCard) {
                    var sum = 0; // 声明加权求和变量
                    if (a_idCard[17].toLowerCase() == 'x') {       // toLowerCase() 方法用于把字符串转换为小写。

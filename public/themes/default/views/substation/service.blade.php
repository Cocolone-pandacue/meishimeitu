                ...
                @foreach($hotList as $v)
                    <li class="clearfix">
                        <div class="media-left">
                            <a href="@if(isset($item['shopId']) && $v['shop_status'] == 1 && $v['shopId']) {!! url('shop/'.$v['shopId']) !!}
                ...
                @foreach($list->toArray()['data'] as $item)
                    <li class="clearfix">
                        <div class="col-sm-2 col-xs-2 m-serivcebox">
                            ...
                            @if(isset($item['shopId']) && isset($item['is_recommend']) && $item['is_recommend'] == 1 && $item['shop_status'] == 1 && $item['shopId'])

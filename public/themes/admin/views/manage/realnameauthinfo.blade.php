...
<div class="g-backrealdetails clearfix bor-border">
    ...
    <div class="realname-bottom clearfix col-xs-12">
        ...
        <p class="col-md-11"><img src="{!! ossUrl($realname->card_front_side) !!}"></p>
    </div>

    <div class="realname-bottom clearfix col-xs-12">
        <p class="col-md-1 text-right">证件反面：</p>
        <p class="col-md-11"><img src="{!! ossUrl($realname->card_back_dside) !!}"></p>
    </div>

    <div class="realname-bottom clearfix col-xs-12">
        <p class="col-md-1 text-right">示范照片：</p>
        <p class="col-md-10"><img src="{!! ossUrl($realname->validation_img) !!}"></p>
    </div>
    {{--<div class="realname-bottom clearfix col-xs-12">

                ...
                <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post" action="/manage/config/phone">
                    ...
                    <div class="form-group basic-form-bottom">
                        ...
                        <div class="col-sm-4">
                            ...
                            @endif
                            @if(!empty($phone['netEase']))
                            <label onclick="tab('.netEase')">
                                <input class="ace" type="radio" name="scheme" value="Aliyun" @if($phone['scheme'] == 'NetEase')checked="checked"@endif>
                                <span class="lbl"> 网易云盾</span>
                            </label>
                            @endif
                        </div>
                    </div>
                    ...
                    <!-- 网易云盾配置 -->
                    @if(!empty($phone['netEase']))
                    <div class="netEase item" @if($phone['scheme'] == 'NetEase')style="display:block;" @else style="display:none;" @endif>
                        <div class="form-group basic-form-bottom">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> appKey： </label>

                            <div class="col-sm-4">
                                <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="appKey" @if($phone['netEase']['appKey'])value="{{$phone['netEase']['appKey']}}" @endif/>
                            </div>
                            <label class="col-sm-5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> (对应开官网发者主账号下的 appKey )</label>
                        </div>
                        <div class="form-group basic-form-bottom">
                            <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> appSecret： </label>

                            <div class="col-sm-4">
                                <input type="text" id="form-field-1" placeholder="" class="col-xs-10 col-sm-12" name="appSecret" @if($phone['netEase']['appSecret'])value="{{$phone['netEase']['appSecret']}}" @endif/>
                            </div>
                            <label class="col-sm-5 cor-gray87"><i class="fa fa-exclamation-circle cor-orange text-size18"></i>(对应开官网发者主账号下的 appSecret ) </label>
                        </div>
                    </div>
                    @endif

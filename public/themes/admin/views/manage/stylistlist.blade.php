<div class="row">
    <div class="col-xs-12">
        <div class="clearfix table-responsive">
            {{-- <div class="space"></div>--}}
            <h3 class="header smaller lighter blue mg-bottom20 mg-top12" >设计师认证</h3>
            <div class="form-inline clearfix  well">
                <form  role="form" action="/manage/stylistAuthList" method="get">
                    ...
                    {{--<div class="form-group search-list ">--}}
                        {{--<label for="namee" class="">身价</label>--}}
                        {{--<input type="text" class="form-control" id="social" name="social" placeholder="请输入身价" @if(isset($merge['social']))value="{!! $merge['social'] !!}"@endif >--}}
                    {{--</div>--}}
                        ...
                        @foreach($realname as $item)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        @if($item->status == 0)
                                            <a class="btn btn-xs btn-success" href="/manage/stylistAuthHandle/{!! $item->id !!}/pass">
                                                <i class="ace-icon fa fa-check bigger-120"></i>成功
                                            </a>
                                            <a class="btn btn-xs btn-danger" href="/manage/stylistAuthHandle/{!! $item->id !!}/deny">
                                                <i class="ace-icon fa fa-ban bigger-120"></i>失败
                                            </a>
                                        @endif
                                        <a class="btn btn-xs btn-warning" href="{!! url('manage/stylistAuth/' . $item->id) !!}">

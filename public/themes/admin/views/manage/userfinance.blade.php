    ...
    <form class="form-inline search-group" role="form" action="{!! url('manage/userFinance') !!}" method="get">
        ...
        <div class="form-group search-list ">
            ...
            <select name="action" id="action">
                ...
                <option value="11" @if(isset($action) && $action == 11)selected="selected"@endif>推荐到平台商铺失败退款</option>
    ...
    <table id="sample-table-1" class="table table-striped table-bordered table-hover">
        ...
        <tr>
            ...
            <td>
                ...
                @elseif($item->action == 10)维权退款@elseif($item->action == 11)推荐到平台商铺失败退款@elseif($item->action == 12)问答打赏
